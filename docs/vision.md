...
Les données économiques françaises existent. Elles sont publiques, gratuites, officielles.
Mais elles sont :
...
**Formule** : ironique × factuel × accessible

- Ironique sans être méchant
- Factuel sans être barbant
- Accessible sans être condescendant
...
- "On est cooked" (niveau historiquement élevé)
- "Score : 74/100 — Bien cuit, comme d'hab."
...
Métriques secondaires : scroll depth, votes cooked/uncooked, taux de partage.
...
## Principe non-politique

France de Macron cite les données, pas les personnes.

Toute critique ou ironie s'adresse aux **tendances économiques observables**, pas à des individus ou partis. La politique est un contexte, pas un jugement.
