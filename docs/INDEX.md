...
| `scripts/qa/check-autonomous-datasets.ts`                    | Validation datasets autonomous (IPC alimentaire + chômage jeunes)             |
...
| `pnpm run qa:phase7`                | Exécuter toute l’automatisation QA Phase 7 (inclut Lighthouse/CWV + datasets autonomous)     |
